...
ssl_args = {
    'sslmode': 'verify-full',
    'sslrootcert': '/home/hai/PycharmProjects/hbao12.github.io/resume_builder/certs/global-bundle.pem'
}
engine = create_engine('postgresql+psycopg2://postgres:c7imS4RQTyMP2F9@database-1.cbsoewagczx3.us-east-2.rds.amazonaws.com:5432/postgres', connect_args=ssl_args)
...
try:
    ...
    conn = psycopg2.connect(
        host='database-1.cbsoewagczx3.us-east-2.rds.amazonaws.com',
        port=5432,
        database='postgres',
        user='postgres',
        password='c7imS4RQTyMP2F9',
        sslmode='verify-full',
        sslrootcert='/home/hai/PycharmProjects/hbao12.github.io/resume_builder/certs/global-bundle.pem'
    )
    cur = conn.cursor()
